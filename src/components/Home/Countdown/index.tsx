...
const CounDown = () => {
  ...
  const deadline = "november, 31, 2026";
        ...
        <div className="relative overflow-hidden z-1 rounded-lg bg-[#D0E9F3] p-4 sm:p-7.5 lg:p-10 xl:p-15">
          <div className="max-w-[422px] w-full">
            ...
            <h2 className="font-bold text-dark text-xl lg:text-heading-4 xl:text-heading-3 mb-3">
              the verified account is coming soon
            </h2>

            <p>stay tuned for the verified account feature and more exciting updates!</p>
          ...
          />
          <Image
            src="/images/countdown/verified-01.png"
            alt="product"
            className="hidden lg:block absolute right-25 xl:right-33 bottom-5 xl:bottom-5 -z-1 "
            width={311}
            height={276}
          />
        </div>
