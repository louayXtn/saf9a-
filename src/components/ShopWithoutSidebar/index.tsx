...
const ShopWithoutSidebar = () => {
  ...
  const realTotalPages = Math.ceil(products.length / productsPerPage);
...
>
  {currentProducts
    .slice() // نعمل نسخة من المصفوفة الأصلية عشان ما نغيرها مباشرة
    .sort((a, b) => b.reviews - a.reviews) // ترتيب تنازلي حسب عدد التقييمات
    .map((item, key) =>
      productStyle === "grid" ? (
