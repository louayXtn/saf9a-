...
//             {/* Table */}
//             <div className="bg-white rounded-[10px] shadow-1 overflow-x-auto">
//               <div className="w-full min-w-[700px]">
//                 {/* Table Header */}
//                 <div className="flex flex-wrap items-center py-5.5 px-7.5">
...
//                     <p className="text-dark">Subtotal</p>
//                   </div>
//                   <div className="flex-1 sm:basis-1/10 text-right">
...
//                 fillRule="evenodd"
//                 clipRule="evenodd"
//                 d="M36.1693 36.2421C35.6126 36.0565 35.0109 36.3574 34.8253 36.9141..."
//                 fill="#8D93A5"
//               />
//             </svg>
//           </div>
          ...
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            ...
            <div className="bg-white rounded-[10px] shadow-1">
              <div className="w-full">
                ...
                <div className="hidden sm:flex items-center py-5.5 px-7.5">
                  <div className="flex-1 sm:basis-2/5">
                    <p className="text-dark">Product</p>
                  </div>
                  <div className="flex-1 sm:basis-1/5">
